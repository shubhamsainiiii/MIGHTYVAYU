      ...
      <div className="container mx-auto px-6 relative z-20 text-center">
        ...
        >
          <button
            ...
            className="bg-primary hover:bg-amber-600 text-white px-8 py-3 rounded-full font-bold text-lg transition-all hover:scale-105 shadow-lg shadow-primary/30"
          >
            About More
          </button>
        </motion.div>
